...
import frog from "../assets/frogjump.png";
import { Page1, Page2 } from "./Newspage";

export default function AllpostPage() {
    const [posts] = useState([
    { id: 1, name: roblox, title: "Free Time Game Development", text: "", page:"/page4", pagename: "Page1" },
    { id: 2, name: frog, title: "Dodge Frog. My First Game", text: "", page:"/page4", pagename: "Page2" },
    { id: 3, name: gameplay, title: "", text: "", page:"/page4", pagename: "" },
    ]);
